...
namespace EzySlice {
    ...
    public sealed class Slicer {
        ...
        public static SlicedHull Slice(GameObject obj, Plane pl, TextureRegion crossRegion, Material crossMaterial) {
            ...
            if (filter == null) {
                Debug.Log("EzySlice::Slice -> Provided GameObject must have a MeshFilter Component.");
            ...
            if (renderer == null) {
                Debug.Log("EzySlice::Slice -> Provided GameObject must have a MeshRenderer Component.");
            ...
            if (mesh == null) {
                Debug.Log("EzySlice::Slice -> Provided GameObject must have a Mesh that is not NULL.");
            ...
            if (materials.Length != submeshCount) {
                Debug.Log("EzySlice::Slice -> Provided Material array must match the length of submeshes.");
                Debug.Log("EzySlice::Slice -> Mats Length = " + materials.Length + ", Submeshes = " + submeshCount);
                //return null;
            }
        ...
        public static SlicedHull Slice(Mesh sharedMesh, Plane pl, Bounds bound, TextureRegion region, int crossIndex)
        {
            if (sharedMesh == null)
            {
                return null;
