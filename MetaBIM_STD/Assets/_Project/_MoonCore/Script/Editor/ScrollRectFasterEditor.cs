...
namespace UnityEditor.UI
{
    ...
    public class ScrollRectFasterEditor : Editor
    {
        ...
        SerializedProperty m_InertiaVelocityMultuplier;
        ...
        protected virtual void OnEnable()
        {
            ...
            m_InertiaVelocityMultuplier = serializedObject.FindProperty("m_InertiaVelocityMultuplier");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(m_ShowDecelerationRate.faded))
            {
                ...
                EditorGUILayout.PropertyField(m_InertiaVelocityMultuplier);
                EditorGUI.indentLevel--;
            }
            EditorGUILayout.EndFadeGroup();
